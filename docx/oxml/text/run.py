...
class CT_SimpleField(BaseOxmlElement):
    ...
    def set_field(self, field_name, properties):
        ...
        #     WD_FIELDCODE.TOC: "TOC",
        # }[field_name]

        field_ = field_name._member_name

        self.instr = field_ + " " + properties
...
class CT_R(BaseOxmlElement):
    ...
    def add_fldChar(self, fldCharType):
        fld = self._add_fldChar()
        fld.fldCharType = fldCharType
        return fld

    def add_instrText(self, instrText=None):
        instr = self._add_instrText()
