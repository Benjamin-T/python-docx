...
from docx.oxml.table import (
    CT_Border, CT_Height, CT_Row, CT_Tbl, CT_TblBorders, CT_TblGrid,
    CT_TblGridCol, CT_TblLayoutType, CT_TblPr, CT_TblWidth, CT_Tc, CT_TcPr,
...
register_element_cls('w:tcBorders',  CT_TblBorders)
